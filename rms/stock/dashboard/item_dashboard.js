...
rms.stock.ItemDashboard = Class.extend({
	init: function(opts) {
		$.extend(this, opts);
		this.make();
	},
	...
	refresh: function() {
		...
		var me = this;
		frappe.call({
			method: 'rms.stock.dashboard.item_dashboard.get_data',
			args: {
...
rms.stock.move_item = function(item, source, target, actual_qty, callback) {
	...
	dialog.set_primary_action(__('Submit'), function() {
		...
		frappe.call({
			method: 'rms.stock.doctype.stock_entry.stock_entry_utils.make_stock_entry',
			args: values,
			callback: function(r) {
