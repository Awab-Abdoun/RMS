...
rms.stock.StockController = frappe.ui.form.Controller.extend({
	onload: function() {
	...
	setup_warehouse_query: function() {
		var me = this;
		rms.queries.setup_queries(this.frm, "Warehouse", function() {
			return rms.queries.warehouse(me.frm.doc);
		});
	},
	...
	show_general_ledger: function() {
		var me = this;
		if(this.frm.doc.docstatus===1) {
			cur_frm.add_custom_button(__('General Ledger'), function() {
				frappe.route_options = {
					voucher_no: me.frm.doc.name,
					from_date: me.frm.doc.posting_date,
					to_date: me.frm.doc.posting_date,
